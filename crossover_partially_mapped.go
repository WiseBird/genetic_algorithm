...
func (crossover *PartiallyMappedCrossover) chooseFirstCrossPoint(genesLen int) int {
	return rand.Intn(genesLen)
}
func (crossover *PartiallyMappedCrossover) chooseSecondCrossPoint(genesLen, crossPoint1 int) int {
